...
This file contains code to model binary coulomb interactions, calculating the scattering angle and terminal velocity 
for a given impact parameter and charge particle pair 
"""
